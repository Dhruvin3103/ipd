              ...
              <div className="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start ml-2"> 
                ...
                <div className="flex flex-shrink-0 items-center">
                  {/* <img
                    ...
                    alt="Your Company"
                  /> */}
                  <Image height={40} width={40} src={tpg_logo} className='rounded-full'/>
                </div>
                  ...
                  <div className="flex space-x-4">
                    {navigation.map((item) => (
                      <a
                        ...
                        item.current ? 'bg-gray-900 text-white' : 'text-blue-100 hover:bg-gray-700 hover:text-white',
...
>
  ...
  <span className="sr-only">View notifications</span>
  <BellIcon className="h-6 w-6" aria-hidden="true" />
  <span className="absolute top-0 right-0 -mt-2 -mr-2 px-2 py-1 bg-black text-white text-xs rounded-full opacity-0 transition-all duration-300 hover:opacity-100">
                  ...
                  <div>
                    <Menu.Button className="relative flex rounded-full bg-gray-800 text-sm focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-800">
                      ...
                      {/* <img
                        ...
                        alt=""
                      /> */}
                      {/* <Image height={40} width={40} className='rounded-full'src={user_logo}/> */}
                      <Image height={40} width={40} className='rounded-full' src={user_logo}/>
